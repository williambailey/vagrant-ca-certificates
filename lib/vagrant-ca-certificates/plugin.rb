...
module VagrantPlugins
  module CaCertificates
    # Vagrant Plugin class that adds custom ca certificates
    #
    ...
    class Plugin < Vagrant.plugin('2')
      ...
      #
      # @raise [VagrantPlugins::CaCertificates::VagrantVersionError] if this plugin
      ...
      def self.check_vagrant_version!
        if !check_vagrant_version(VAGRANT_VERSION_REQUIREMENT)
          msg = I18n.t(
            'vagrant_ca_certificates.errors.vagrant_version',
